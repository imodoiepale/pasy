(function ($) {
    ...
    heroSlider.slick({
      ...
      slidesToShow: 1,
      prevArrow:
        '<button type="button" class="slick-prev"><img src="https://img.icons8.com/sf-black-filled/40/000000/left.png"/></button>',
      nextArrow:
        '<button type="button" class="slick-next"><img src="https://img.icons8.com/sf-black-filled/20/000000/right.png"/></button>',
      responsive: [
        {
          breakpoint: 767,
          settings: {
    ...
    movieSlider3.slick({
      ...
      autoplay: false,
      prevArrow:
        '<button type="button" class="slick-prev"><img src="https://img.icons8.com/sf-black-filled/40/000000/left.png"/></i> </button>',
      nextArrow:
        '<button type="button" class="slick-next"><img src="https://img.icons8.com/sf-black-filled/20/000000/right.png"/></button>',
      responsive: [
        {
    ...
    $.scrollUp({
      scrollText:
        '<img src="https://img.icons8.com/sf-black/20/000000/up.png"/>',
      easingType: "linear",
      scrollSpeed: 900,
      animation: "fade",
    });   
